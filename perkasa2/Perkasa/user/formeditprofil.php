	...
	<div class='utama'>
		<a name='atas'><div class='header'></div></a>
      		 <div class='menu' align='center'><?php include'../include/menuutamauser.php'; ?></div>
				 <div class='isi'>
		 			<h3>Edit Profil</h3>
		  			<form action='pro_updateprofil.php' method='post'>
		  			<div class='formeditprofil'>
		  		 	<table border='0'>
						...
						<tr><td colspan='2' align='right'><input class='tombol' type='button' value='Batal' onclick='javascript:history.go(-1);'>&nbsp;&nbsp;&nbsp;<input class='tombol' type='submit' value='Perbaharui'></td></tr>
