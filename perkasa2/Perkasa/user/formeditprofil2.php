...
<html>
<head><title>Perkasa Gaming Shop</title>
	...
	<div class='utama'>
		<a name='atas'><div class='header'></div></a>
      		 <div class='menu' align='center'><?php include'../include/menuutamauser.php'; ?></div>
				 <div class='isi'>
		 			<h3>Edit Profil</h3>
		  			<form action='pro_updateprofil2.php' method='post'>
		  			<div class='formeditprofil'>
		  		 	<table border='0'>
						...
						<tr><td colspan='2' align='right'><input type='button' value='Batal' class='tombol' onclick='javascript:history.go(-1);'>&nbsp;&nbsp;&nbsp;<input type='submit' value='Perbaharui' class='tombol'></td></tr>
